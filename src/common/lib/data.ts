...
export const skillsData = [
  ['.NET', '/svgs/dotnet.svg'],
  ['CSharp', '/svgs/c--4.svg'],
  ['Azure Cloud', '/svgs/azure-2.svg'],
  ['Azure DevOps', '/svgs/azure-1.svg'],
  ['JavaScript', '/svgs/javascript-js.svg'],
  ['TypeScript', '/svgs/typescript-icon.svg'],
  ['Angular', '/svgs/angular-icon.svg'],
  ['HTML', '/svgs/html-5-svgrepo-com.svg'],
  ['Semantic UI', '/svgs/semantic-ui.svg'],
  ['Material UI', '/svgs/material.svg'],
  ['Tailwind', '/svgs/tailwind-css.svg'],
  ['MSSQL', '/svgs/mssql.svg'],
  ['Firebase', '/svgs/firebase-1.svg'],
